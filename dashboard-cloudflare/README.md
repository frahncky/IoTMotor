...
- O ESP32-01 comeca com todos os relés desligados, desliga ao perder MQTT/Wi-Fi e tem limite de ensaio de **5 minutos**. A sequencia estrela-triangulo usa uma pausa de 700 ms entre os estados e nao substitui intertravamentos eletricos.
